...
import com.example.app.service.OrderItemService;
...
public class OrderItemController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<OrderItem> getOrderItem(@PathVariable("id") final Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateOrderItem(@PathVariable("id") final Long id,
            @RequestBody @Valid final OrderItemDTO orderItemDTO) {
